...
function drawPage($_gridster,page_vo) {
    ...
    var gridster = $_gridster.gridster({
        //widget_selector: 'li',
    ...
    for(var i = 0 ;i < layout_arr.length; i++) {
        ...
        if(config_arr[i].block_type === 'view') {
            ...
            if(config_arr[i].graph_type === 'clock') {
                ...
                $('#table_' + i).append(block_arr[i].html_contents);// 待完成
