...
public class BriefHostDTO {
    ...
    public static final String[] PROPERTY_NAMES = {"hostid", "name","custom_state","custom_available_state","description"};
    ...
    public BriefHostDTO setDescription(String description) {
